...
numShots=list(np.arange(20)) # a list containing indices of images to actually consider (i.e. [0,2,3] will load first, third and fourth image
...
B_delays = [582] #list of B delays to loop over
...
for delay in B_delays: #loop over all B delays
    run_path = r'\100mbar_Bdel' + str(delay) + r'_t0' #unique bit of the path to the folder for a specific processing run
    ...
    for sigPath,saveloc,peak_center,ignore_rects in zip([sigPath_IR, sigPath_Green],
