...
B_delays = [552,556,560,565,569,573,577,582,587,592,598,604,611,620,631] #list of B delays to loop over
...
for mbar in pressures: #loop over all pressures
    for delay in B_delays: #loop over all B delays
        ...
        saveloc_IR = r'C:\Users\kalos\Documents\kPAC\ChannelAnalysis_CALA_Sept25\channel_analysis_250910_largeFFT\phase_maps' + run_path + r'\Interferometry2' #location to save the processed data of this specific processing run
        saveloc_Green = r'C:\Users\kalos\Documents\kPAC\ChannelAnalysis_CALA_Sept25\channel_analysis_250910_largeFFT\phase_maps' + run_path + r'\Interferometry1' #location to save the processed data of this specific processing run
