...
boundary_points_sig_IR = [(671, 402), (780, 511)]#IR
boundary_points_sig_Green = [(757, 585), (866, 694)]#Green
...
B_delays = [552,556,560,565,569,573,577,582,587,592,598,604,611,620,631,643] #list of B delays to loop over
pressures = [80,60,40,20] #list of pressures to loop over

common_path = r"D:\kPAC\2025_09_10Backfill2" #portion of path common to both raw AND processed data
...
for mbar in pressures: #loop over all pressures
    for delay in B_delays: #loop over all B delays
        ...
        saveloc_IR = r'C:\Users\kalos\Documents\kPAC\ChannelAnalysis_CALA_Sept25\channel_analysis_250910\phase_maps' + run_path + r'\Interferometry2' #location to save the processed data of this specific processing run
        saveloc_Green = r'C:\Users\kalos\Documents\kPAC\ChannelAnalysis_CALA_Sept25\channel_analysis_250910\phase_maps' + run_path + r'\Interferometry1' #location to save the processed data of this specific processing run
